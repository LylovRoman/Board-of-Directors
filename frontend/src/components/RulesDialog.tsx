...
export function RulesDialog(props: { onClose: () => void }) {
  const tabs = [
    ...
    },
    {
      id: "memo-advanced",
      label: "Усиление",
      text: "Обычные Директора получают стандартную тройку. Комплаенс после принятой Диверсии, если партия продолжается, получает усиленную пару выбранного типа.",
      bullets: ["Риски: в паре есть хотя бы одна оставшаяся цель Крота.", "Возможности: в паре есть хотя бы одно решение, которое не является оставшейся целью Крота.", "Этот меморандум приватен и не выдается Комплаенсу на старте."],
    },
    {
      id: "major",
      label: "Major vote",
