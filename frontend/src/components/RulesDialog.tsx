  ...
  const tabs = [
    {
      ...
      bullets: ["Совет побеждает, когда принимает 3 чистых решения.", "Крот побеждает, когда его цели дают 3 очка саботажа.", "Подкоп дает 1 очко, Диверсия дает 2 только при личном голосе Крота и 1 без него."],
    },
    {
      id: "start",
      label: "Старт",
    ...
    },
    {
      ...
      bullets: ["Возможности: в тройке есть хотя бы одно чистое решение.", "Риски: в тройке есть хотя бы одна цель Крота.", "Комплаенс получает стартовый усиленный меморандум выбранного типа."],
    },
    {
      id: "memo-advanced",
      label: "Усиление",
      text: "Обычные Директора получают стандартную тройку. Комплаенс получает усиленную стартовую пару выбранного типа.",
      bullets: ["Риски: в паре есть хотя бы одна цель Крота.", "Возможности: в паре есть хотя бы одно решение, которое не является целью Крота.", "Этот меморандум приватен и выдается Комплаенсу на старте."],
    },
    {
      id: "major",
      label: "Major vote",
    ...
    },
    {
      ...
      bullets: ["Если Комплаенс поймал личный голос Крота за принятую Диверсию, Крот получает одну попытку Развала дела, когда эта настройка включена Host в лобби.", "Правильная догадка отменяет поимку и оставляет Диверсию принятой; ошибка дает победу Совету.", "Если Развал дела выключен, поимка сразу дает победу Совету."],
    },
    {
      id: "governance",
      label: "Governance",
